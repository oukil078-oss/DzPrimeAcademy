...
const HERO_COPY = {
  ar: {
    ...
    sub: 'أجب والتحق بالبكالوريا والجامعة مع حصص التحضير المجانية، بث الدروس المباشر، بوت الامتحانات والملخصات الذكي للتحضير السريع، وشبكة سفراء معتمدين في 58 ولاية.',
  ...
  fr: {
    ...
    sub: 'Réussissez le BAC et l\'université avec des sessions de préparation gratuites, du live, un bot intelligent de résumés de cours et annales d\'examens, et un réseau d\'ambassadeurs certifiés dans les 58 wilayas.',
  ...
  en: {
    ...
    sub: 'Succeed at the BAC and university with free prep sessions, live classes, a smart bot for module summaries & exam archives, and a certified ambassador network across 58 wilayas.',
